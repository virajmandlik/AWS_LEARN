...
-   [Find an Amazon EC2 instance type](./instance-discovery.html)

-   [Get recommendations from EC2 instance type finder](./get-ec2-instance-type-recommendations.html)

-   [Get EC2 instance recommendations from Compute Optimizer](./ec2-instance-recommendations.html)

-   [Amazon EC2 instance type changes](./ec2-instance-resize.html)

-   [Burstable performance instances](./burstable-performance-instances.html)

-   [Performance acceleration with GPU instances](./configure-gpu-instances.html)

-   [Amazon EC2 Mac instances](./ec2-mac-instances.html)

-   [Amazon EBS-optimized instance types](./ebs-optimized.html)

-   [CPU options for Amazon EC2 instances](./instance-optimize-cpu.html)

-   [AMD SEV-SNP for Amazon EC2 instances](./sev-snp.html)

-   [Processor state control for Amazon EC2 Linux instances](./processor_state_control.html)
...
-   AMD Secure Encrypted Virtualization-Secure Nested Paging ([SEV-SNP](./sev-snp.html))
...
-   Use SageMaker AI, a fully-managed service that is the easiest way to get started with machine learning models. For more information, see [Get Started with SageMaker AI](https://docs.aws.amazon.com/sagemaker/latest/dg/gs.html) in the _Amazon SageMaker AI Developer Guide_.
